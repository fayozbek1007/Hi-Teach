...
const Contactinfo = () => {
    return (
        <div>
                    ...
                    <div>
                        <div>
                            ...
                            <div className='mt-[20px] flex gap-[20px] items-center'>
                                <img className='w-[30px] h-[30px]' src="https://cdn.pixabay.com/photo/2020/10/17/13/21/telegram-5662082_1280.png" alt="" />
                                <img className='w-[40px] h-[40px]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZgGo1dFTnwof_9D4nCtubqVgOVhLm8iBZmQ&s" alt="" />
                            </div>
                        </div>
                        <div className='mt-[10px]'>
                            <h1 className='font-[600] text-[20px]'>We are in social networks</h1>
                            <div className='flex gap-[10px] mt-[15px]'>
                                <img className='w-[40px] h-[40px]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTH7Zzq8Nfnm9bZM7G3TMvK5H3_bBYOjEGuXg&s" alt="" />
                                <img className='w-[40px] h-[40px]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSC0ouaIaXYSPCpVxkRhdvCVAkECK4rOvh_YQ&s" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <iframe  className='w-full rounded-[20px] border-[1px] border-[#00000031] mt-[20px]'  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d749.9202283718834!2d69.255847!3d41.250508!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8b278f47926f%3A0x58c5ded3abff2147!2sHi-tech%20Orient%20Medical!5e0!3m2!1sen!2sus!4v1725888685920!5m2!1sen!2sus"  height="450" allowfullscreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
